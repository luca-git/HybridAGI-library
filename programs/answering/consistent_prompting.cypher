...
(is_there_enought_answer:Decision {name:"Is there enought different answer to vote (3 is good enought)?", purpose:"Check the consitency of the Answer by predicting it multiple times to then vote for the best. Let's think this out in a step by step way to be sure we have the right answer."}),
